  ...
  return (
    <SafeAreaView style={styles(colors).container}>
      <View style={styles(colors).header}>
        ...
        <Text style={styles(colors).headerTitle}>Privacy Policy</Text>
      ...
      {androidModalStep === "policy" ? (
        ...
        >
          ...
          <Text style={styles(colors).paragraph}>
            ...
            terms. Please refer to TMDb's privacy policy for information on how
            they handle this data.
          </Text>

          <Text style={styles(colors).sectionTitle}>Local Storage</Text>
          <Text style={styles(colors).paragraph}>
            Any search history or preferences are stored locally on your device
            to improve your experience. This data stays on your device and is
            not transmitted to our servers or any third parties (except for the
            actual search queries to TMDb as mentioned above).
          </Text>
          ...
          <View style={styles(colors).actionButtonsContainer}>
            <TouchableOpacity
              ...
              onPress={() => navigation.goBack()}
            >
              <Text style={styles(colors).acceptButtonText}>I Understand</Text>
            </TouchableOpacity>
