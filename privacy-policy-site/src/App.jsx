  ...
  return (
    <div style={{ padding: "2rem", fontFamily: "sans-serif", maxWidth: "800px", margin: "0 auto", lineHeight: "1.6" }}>
      ...
      <p style={{ marginBottom: "16px" }}>
        Thank you for using I Am DB. This Privacy Policy explains how we handle your information when you use our application.
      </p>

      <h2 style={{ color: "#333", marginTop: "24px", marginBottom: "12px" }}>No Data Collection</h2>
      <p style={{ marginBottom: "16px" }}>
        I Am DB does not collect any personal information or usage data from you. All your interactions with the app remain private.
      </p>
